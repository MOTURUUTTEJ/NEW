...
const Welcome = () => {
    ...
    return (
        <div className="relative w-full h-screen font-sans overflow-hidden bg-black text-white">
            <canvas ref={canvasRef} className="absolute inset-0 z-0 pointer-events-none" aria-hidden="true"></canvas>
            ...
            <div className="relative z-10 w-full h-full flex flex-col items-center justify-center gap-6 pointer-events-none px-4 text-center">
                ...
                <div className="mt-8 flex gap-6 pointer-events-auto">
                    <Link to="/login" className="px-8 py-3 bg-transparent border-2 border-[#ff9900] text-[#ff9900] hover:bg-[#ff9900] hover:text-[#0f1b2a] focus-visible:ring-4 focus-visible:ring-[#ff9900]/50 font-bold rounded-lg transition-colors duration-300 shadow-[0_0_15px_rgba(255,153,0,0.3)] hover:shadow-[0_0_25px_rgba(255,153,0,0.6)] backdrop-blur-sm">
                        TEAM LOGIN
                    </Link>
                    <Link to="/admin/login" className="px-8 py-3 bg-transparent border-2 border-slate-500 text-slate-300 hover:bg-slate-300 hover:text-[#0f1b2a] focus-visible:ring-4 focus-visible:ring-slate-300/50 font-bold rounded-lg transition-colors duration-300 backdrop-blur-sm">
                        ADMIN LOGIN
                    </Link>
                </div>
            </div>
